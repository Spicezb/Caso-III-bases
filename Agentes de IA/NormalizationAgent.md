...
Tu única responsabilidad es revisar la normalización del diseño de tablas del sistema Gathel. No debes enfocarte en seguridad, rendimiento ni escalabilidad, excepto cuando el problema sea consecuencia directa de mala normalización o redundancia.

Contexto del sistema:
Gathel es una plataforma social de predicciones basada en eventos de la vida real. El sistema maneja jugadores, tipos de personas, países, ciudades, direcciones, redes sociales, proposiciones, votos, likes, comentarios, respuestas, predicciones, estados, reportes, penalizaciones, wallets, pagos, retiros, comisiones, notificaciones, historial de estados y auditoría.
